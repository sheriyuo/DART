    ...
    def _build_model_optimizer(
        ...
        if fsdp_strategy == "fsdp":
            actor_module_fsdp = FSDP(
                ...
                use_orig_params=self.config.actor.fsdp_config.get("use_orig_params", True),
        ...
        if role == "actor" and optim_config is not None:
            ...
            params_to_optimize = filter(lambda p: p.requires_grad, actor_module_fsdp.parameters())
